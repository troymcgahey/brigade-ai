---
name: prepare-roasted-potatoes
description: Plan and execute the roasted potato recipe using the available kitchen MCP tools. Use when asked to prepare, cook, or simulate a roasted potato side dish, or when ass  dinneb that specifically calls for roasted potatoes.
---
